import {
  ...
  __glob,
  allTerms
} from "./chunk-OLTXUVKX.mjs";

// data/i18n/es.json
var require_es = __commonJS({
  "data/i18n/es.json"(exports, module) {
    module.exports = {
      llm: {
      ...
      rag: {
        term: "RAG (Generaci\xF3n Aumentada por Recuperaci\xF3n)",
      ...
      depin: {
        term: "DePIN (Redes de Infraestructura F\xEDsica Descentralizada)",
      ...
      tpu: {
        term: "TPU (Unidad de Procesamiento de Transacciones)",
      ...
      tvu: {
        term: "TVU (Unidad de Validaci\xF3n de Transacciones)",
      ...
      svm: {
        term: "SVM (M\xE1quina Virtual Solana)",
      ...
      sbf: {
        term: "SBF (Formato de Bytecode Solana)",
      ...
      vdf: {
        term: "VDF (Funci\xF3n de Retardo Verificable)",
      ...
      "optimistic-confirmation": {
        term: "Confirmaci\xF3n Optimista",
      ...
      "genesis-config": {
        term: "Configuraci\xF3n G\xE9nesis",
      ...
      amm: {
        term: "AMM (Creador de Mercado Automatizado)",
      ...
      dex: {
        term: "DEX (Exchange Descentralizado)",
      ...
      tps: {
        term: "TPS (Transacciones por Segundo)",
      ...
      mev: {
        term: "MEV (Valor M\xE1ximo Extra\xEDble)",
      ...
      "public-key-cryptography": {
        term: "Criptograf\xEDa de Clave P\xFAblica",
      ...
      pda: {
        term: "Direcci\xF3n Derivada de Programa (PDA)",
      ...
      cpi: {
        term: "Invocaci\xF3n Entre Programas (CPI)",
      ...
      serialization: {
        term: "Serializaci\xF3n / Deserializaci\xF3n",
      ...
      "compute-budget": {
        term: "Presupuesto de C\xF3mputo",
      ...
      "compute-units": {
        term: "Unidades de C\xF3mputo (CU)",
      ...
      idl: {
        term: "IDL (Lenguaje de Definici\xF3n de Interfaz)",
      ...
      audit: {
        term: "Auditor\xEDa de Seguridad",
      ...
      "token-2022": {
        term: "Token-2022 (Extensiones de Token)",
      ...
      "associated-token-account": {
        term: "Cuenta de Token Asociada (ATA)",
      ...
      "confidential-transfers": {
        term: "Transferencias Confidenciales",
      ...
      dapp: {
        term: "dApp (Aplicaci\xF3n Descentralizada)",
      ...
      "seed-phrase": {
        term: "Frase Semilla (Mnem\xF3nico)",
...
var require_pt = __commonJS({
  "data/i18n/pt.json"(exports, module) {
    module.exports = {
      llm: {
        term: "LLM (Modelo de Linguagem Grande)",
        definition: "A neural network trained on vast text corpora to understand and generate human language. LLMs (GPT-4, Claude, Llama, Gemini) use transformer architectures with billions of parameters. They power chatbots, code generation, summarization, and reasoning tasks. In blockchain development, LLMs assist with smart contract writing, audit review, documentation, and code explanation."
      },
      transformer: {
        term: "Transformer",
      ...
      rag: {
        term: "RAG (Gera\xE7\xE3o Aumentada por Recupera\xE7\xE3o)",
        definition: "An AI architecture that combines LLMs with external knowledge retrieval. Instead of relying solely on training data, RAG systems retrieve relevant documents from a knowledge base (using embeddings and vector search), then provide them as context to the LLM. RAG reduces hallucinations and enables up-to-date responses. Useful for blockchain documentation bots and developer assistants."
      },
      embedding: {
        term: "Embedding",
      ...
      depin: {
        term: "DePIN (Redes de Infraestrutura F\xEDsica Descentralizada)",
        definition: "Blockchain protocols that coordinate and incentivize physical infrastructure through token rewards. DePIN projects on Solana include: Helium (wireless networks), Render (GPU rendering), Hivemapper (mapping), and io.net (distributed GPU compute for AI). Contributors provide physical resources (hardware, bandwidth) and earn tokens. DePIN bridges blockchain economics with real-world infrastructure."
      },
      "gpu-compute": {
        term: "GPU Compute (Decentralized)",
      ...
      "proof-of-stake": {
        term: "Prova de Participa\xE7\xE3o (PoS)",
        definition: "A consensus mechanism where validators are selected to produce blocks based on the amount of cryptocurrency they have staked (locked) as collateral. PoS is energy-efficient compared to Proof of Work. Misbehaving validators risk losing their stake (slashing). Solana, Ethereum (post-Merge), Cosmos, and Cardano use PoS variants."
      },
      "proof-of-work": {
        term: "Prova de Trabalho (PoW)",
        definition: "A consensus mechanism where miners compete to solve computationally expensive puzzles to produce blocks and earn rewards. PoW provides strong security (51% attack resistance) but is energy-intensive. Bitcoin and pre-Merge Ethereum use PoW. The difficulty adjusts to maintain target block times regardless of total network hash power."
      },
      "distributed-ledger": {
        term: "Livro-Raz\xE3o Distribu\xEDdo",
        definition: "A database replicated and synchronized across multiple nodes in a network without central administration. All participants maintain identical copies of the ledger. Changes are propagated through consensus. Blockchains are the most common type of distributed ledger, but not all distributed ledgers use a chain-of-blocks structure."
      },
      "hash-function": {
        term: "Hash Function (Cryptographic)",
      ...
      tpu: {
        term: "TPU (Unidade de Processamento de Transa\xE7\xF5es)",
        definition: "Transaction Processing Unit\u2014the pipeline within a leader validator that ingests, verifies, and executes transactions. The TPU has stages: fetch (receive packets via QUIC), sigverify (verify Ed25519 signatures), banking (execute against current bank state), and broadcast (shred and send via Turbine). Non-leader validators forward transactions to the current leader's TPU."
      },
      tvu: {
        term: "TVU (Unidade de Valida\xE7\xE3o de Transa\xE7\xF5es)",
        definition: "Transaction Validation Unit\u2014the pipeline on non-leader validators that receives shreds, reconstructs blocks, and replays transactions. TVU stages include: shred-fetch, retransmit, replay (execute transactions and verify results), and vote (submit Tower BFT votes). TVU runs continuously on all validators."
      },
      "replay-stage": {
        term: "Est\xE1gio de Replay",
        definition: "The TVU component that replays received blocks by re-executing all transactions against the bank state. Replay stage verifies that transaction results match the leader's claimed results, updates the bank, and generates Tower BFT votes for valid blocks. If a replayed block is invalid, the validator marks that fork as dead."
      },
      bank: {
        term: "Bank",
      ...
      ledger: {
        term: "Livro-Raz\xE3o (Ledger)",
        definition: "The complete ordered history of all transactions processed by the Solana cluster. The ledger is composed of sequential blocks (one per slot), each containing entries of transactions ordered by PoH. Validators store the ledger locally in Blockstore, and warehouse nodes or Bigtable archives provide long-term historical access."
      },
      "genesis-block": {
        term: "Bloco G\xEAnesis",
        definition: "The first block (slot 0) of a Solana cluster that defines initial configuration: the mint account, initial token supply, built-in program deployments, and cluster parameters. The genesis config is generated by the `solana-genesis` tool and shared among all validators to bootstrap a new cluster."
      },
      sealevel: {
        term: "Sealevel",
      ...
      vdf: {
        term: "VDF (Fun\xE7\xE3o de Atraso Verific\xE1vel)",
        definition: "Verifiable Delay Function\u2014a function that takes a prescribed amount of sequential computation to evaluate but whose output can be quickly verified. Solana's Proof of History uses a SHA-256 hash chain as a practical VDF: computing the chain is inherently sequential, but verifying any segment can be parallelized across multiple cores."
      },
      "sha256-hash-chain": {
        term: "Cadeia de Hash SHA-256",
        definition: "The core mechanism of Proof of History. A SHA-256 hash is computed sequentially\u2014each hash takes the previous hash as input\u2014creating an ordered, unforgeable timestamp sequence. The PoH generator runs approximately 400,000 hashes per slot. Data (transactions) can be inserted into the chain by mixing their hash with the current state."
      },
      finality: {
        term: "Finalidade",
      ...
      "optimistic-confirmation": {
        term: "Confirma\xE7\xE3o Otimista",
        definition: "A transaction confirmation level achieved when 66.7%+ of total stake has voted on the slot, typically within ~400ms. Optimistic confirmation provides high probability of finality without waiting for full root depth. It corresponds to the 'confirmed' commitment level in RPC queries."
      },
      rooted: {
        term: "Rooted",
      ...
      "genesis-config": {
        term: "Configura\xE7\xE3o G\xEAnesis",
        definition: "The configuration file that defines the initial state of a Solana cluster at genesis, including the initial token supply, built-in program deployments, cluster parameters (ticks per slot, slots per epoch), fee schedule, and rent configuration. The genesis config is generated by the solana-genesis tool and must be shared identically among all validators to bootstrap a cluster."
      },
      leader: {
        term: "Leader",
      ...
      amm: {
        term: "AMM (Formador de Mercado Automatizado)",
        definition: "A protocol that enables token swaps using algorithmic pricing against pooled liquidity instead of matching individual buyers and sellers. AMMs use mathematical formulas (typically constant product x*y=k) to determine prices based on the ratio of tokens in a liquidity pool. On Solana, major AMMs include Raydium, Orca, and Meteora."
      },
      clmm: {
        term: "CLMM (Concentrated Liquidity Market Maker)",
      ...
      dex: {
        term: "DEX (Exchange Descentralizada)",
        definition: "A protocol for trading tokens directly on-chain without a centralized intermediary. Solana DEXs use either AMM pools (Raydium, Orca, Meteora) or on-chain order books (Phoenix, OpenBook). DEXs are composable\u2014aggregators like Jupiter route through multiple DEXs for optimal pricing."
      },
      "order-book": {
        term: "Order Book (On-Chain)",
      ...
      tps: {
        term: "TPS (Transa\xE7\xF5es por Segundo)",
        definition: "The rate at which a Solana cluster processes and commits transactions; Solana's theoretical maximum exceeds 65,000 TPS due to its parallel execution model, though real-world sustained throughput on Mainnet Beta typically ranges from 2,000\u20135,000 non-vote TPS under normal load. Vote transactions (used for consensus) make up a significant portion of all on-chain activity and are counted separately. High TPS is enabled by Proof of History timestamps, Sealevel parallel execution, and Gulf Stream mempool-less forwarding."
      },
      "parallel-execution": {
        term: "Parallel Transaction Execution",
      ...
      "priority-fee": {
        term: "Taxa de Prioridade",
        definition: "An optional additional fee paid on top of the base fee to increase the likelihood that a transaction is processed quickly by the current leader, expressed as a price in micro-lamports per compute unit (CU). The total priority fee equals (compute unit price \xD7 compute unit limit) / 1,000,000 lamports. Leaders sort transactions in their queue by fee-per-CU, so setting a competitive priority fee is the primary mechanism for ensuring reliable transaction landing during congestion."
      },
      "transaction-fee": {
        term: "Taxa de Transa\xE7\xE3o",
        definition: "The total SOL cost to submit a transaction on Solana, composed of the base fee (5,000 lamports per signature) plus any optional priority fee (compute unit price \xD7 compute units consumed). Unlike Ethereum, Solana fees are not purely dynamic gas auctions \u2014 the base fee is fixed and priority fees are additive. Fees are deducted from the fee-payer account before execution; if the account lacks sufficient SOL, the transaction fails."
      },
      "fee-market": {
        term: "Fee Market (Local/Global)",
      ...
      mev: {
        term: "MEV (Valor M\xE1ximo Extra\xEDvel)",
        definition: "The profit a block producer (leader) or sophisticated trader can extract by controlling the ordering, inclusion, or exclusion of transactions within a block \u2014 including strategies like front-running, back-running, sandwich attacks, and arbitrage. On Solana, MEV dynamics differ from Ethereum because there is no public mempool; transactions are forwarded directly to the current leader, making latency and validator relationships central to MEV capture. The Jito infrastructure provides the dominant MEV marketplace on Solana through bundles and tips."
      },
      jito: {
        term: "Jito (MEV Infrastructure)",
      ...
      "public-key-cryptography": {
        term: "Criptografia de Chave P\xFAblica",
        definition: "A cryptographic system using mathematically linked key pairs: a public key (shared freely) and a private key (kept secret). Used for digital signatures (sender signs with private key, anyone verifies with public key) and encryption (encrypt with public key, decrypt with private key). Solana uses Ed25519 for signatures and Curve25519/Ristretto255 for encryption."
      },
      "event-driven": {
        term: "Event-Driven Architecture",
      ...
      instruction: {
        term: "Instru\xE7\xE3o",
        definition: "A single operation within a transaction that invokes a program. An instruction specifies: (1) the program ID to call, (2) an array of account metas (pubkey, is_signer, is_writable), and (3) an opaque data byte array. Programs decode the instruction data to determine which operation to perform."
      },
      transaction: {
        term: "Transa\xE7\xE3o",
        definition: "An atomic unit of execution containing one or more instructions, a recent blockhash, and one or more signatures. All instructions in a transaction execute sequentially and atomically\u2014if any instruction fails, the entire transaction reverts. Transactions have a 1,232-byte size limit (matching IPv6 MTU) and a default 200,000 CU budget."
      },
      "versioned-transaction": {
        term: "Versioned Transaction",
      ...
      pubkey: {
        term: "Chave P\xFAblica (Pubkey)",
        definition: "A 32-byte Ed25519 public key that serves as the unique address for accounts on Solana. Pubkeys are displayed as Base58-encoded strings (e.g., '11111111111111111111111111111111' for the System Program). Every account, program, and PDA is identified by its pubkey."
      },
      pda: {
        term: "Endere\xE7o Derivado de Programa (PDA)",
        definition: "An account address derived deterministically from a program ID and a set of seeds, with no corresponding private key. PDAs are created by finding a pubkey that does NOT lie on the Ed25519 curve (using a bump seed). Since there's no private key, only the deriving program can sign for the PDA via invoke_signed, making PDAs ideal for program-controlled state."
      },
      seeds: {
        term: "Seeds",
      ...
      cpi: {
        term: "Invoca\xE7\xE3o Entre Programas (CPI)",
        definition: "A mechanism for one program to call another program's instructions during execution. CPIs enable composability\u2014e.g., a DeFi program can call the Token Program to transfer tokens. CPI depth is limited to 4 levels. The caller passes accounts and instruction data, and the callee runs with the same transaction context."
      },
      invoke: {
        term: "invoke()",
      ...
      "rent-exemption": {
        term: "Isen\xE7\xE3o de Aluguel",
        definition: "The state where an account holds enough lamports to cover two years of rent, making it effectively permanent. The minimum balance is approximately 0.00089088 SOL per byte of data. Since Solana requires all new accounts to be rent-exempt, this is the minimum funding required when creating accounts."
      },
      owner: {
        term: "Propriet\xE1rio (Conta)",
        definition: "The program that has exclusive write access to an account's data and can debit its lamport balance. Every account has an owner field (a program pubkey). The System Program owns all new/wallet accounts. When a program creates a derived account, it typically assigns itself as owner to manage that account's state."
      },
      authority: {
        term: "Autoridade",
      ...
      serialization: {
        term: "Serializa\xE7\xE3o / Desserializa\xE7\xE3o",
        definition: "The process of converting in-memory data structures to bytes (serialization) and back (deserialization) for on-chain storage. Solana programs primarily use Borsh, though some use bincode or custom formats. Anchor's #[account] macro auto-derives Borsh serialization. Incorrect deserialization (e.g., missing length checks) is a common vulnerability class."
      },
      "address-lookup-table": {
        term: "Address Lookup Table (ALT)",
      ...
      "compute-budget": {
        term: "Or\xE7amento de Computa\xE7\xE3o",
        definition: "The maximum compute units a transaction can consume. Default is 200,000 CU per instruction (max 1.4M CU per transaction). Programs can request specific limits via the ComputeBudgetProgram's SetComputeUnitLimit instruction. Under-requesting CU risks transaction failure; over-requesting wastes priority fee budget."
      },
      "compute-units": {
        term: "Unidades de Computa\xE7\xE3o (CU)",
        definition: "A measure of computational resources consumed by transaction execution, analogous to gas on Ethereum. Each BPF instruction costs CU; syscalls have predefined CU costs (e.g., SHA-256: 85 CU base + per-byte). Default per-instruction limit is 200,000 CU; max per-transaction is 1,400,000 CU. Priority fee cost = CU price \xD7 CU consumed."
      },
      log: {
        term: "Program Log (msg! / sol_log)",
      ...
      idl: {
        term: "IDL (Linguagem de Defini\xE7\xE3o de Interface)",
        definition: "Interface Definition Language\u2014a JSON specification that describes a program's instructions, accounts, types, and error codes. Anchor auto-generates the IDL from the program source code. Client libraries (TypeScript, Python) use the IDL to serialize/deserialize instruction data and accounts, enabling type-safe interaction without manual encoding."
      },
      "close-account": {
        term: "Close Account",
      ...
      "integer-overflow": {
        term: "Overflow / Underflow de Inteiro",
        definition: "A class of arithmetic vulnerabilities where an integer computation produces a result outside the bounds of its fixed-width type, wrapping around silently in Rust's release builds (since Rust panics on overflow only in debug mode), yielding an incorrect value that can corrupt token balances, borrow limits, or access control counters. For example, subtracting a larger u64 from a smaller one wraps to near u64::MAX (~1.8 \xD7 10^19), which could be interpreted as an enormous balance. Solana programs must use Rust's checked_add, checked_sub, checked_mul, and checked_div methods (or the saturating_* / wrapping_* variants with deliberate intent) on all financial arithmetic to eliminate this class of bugs."
      },
      "checked-math": {
        term: "Checked Math",
      ...
      audit: {
        term: "Auditoria de Seguran\xE7a",
        definition: "A formal, structured review of a Solana program's source code, architecture, and deployment configuration by experienced security researchers, aimed at identifying vulnerabilities \u2014 including but not limited to the OWASP-equivalent Solana Top 10 (missing signer checks, owner checks, arithmetic errors, etc.) \u2014 before mainnet deployment. Reputable Solana-focused audit firms include OtterSec, Ackee Blockchain, sec3 (formerly Soteria), Neodyme, Trail of Bits, and Halborn; most audits produce a severity-rated finding report (critical, high, medium, low, informational) that programs are expected to remediate and publish. A single audit is considered minimum due diligence for programs holding significant user funds; continuous auditing and bug bounties on platforms like Immunefi are considered best practice."
      },
      fuzzing: {
        term: "Fuzzing (Trident)",
      ...
      "token-2022": {
        term: "Token-2022 (Extens\xF5es de Token)",
        definition: "The next-generation token program (TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb) that extends SPL Token with configurable extensions. Extensions include transfer fees, confidential transfers, transfer hooks, permanent delegate, non-transferable tokens, interest-bearing tokens, metadata, and more. Token-2022 is backwards-compatible with SPL Token for basic operations."
      },
      mint: {
        term: "Mint",
      ...
      "associated-token-account": {
        term: "Conta de Token Associada (ATA)",
        definition: "A deterministically derived token account for a given wallet and mint, using the PDA seeds [wallet, token_program, mint]. ATAs provide a canonical address so anyone can send tokens to a wallet without the recipient creating an account first. The ATA program creates the account on first use, funded by the sender."
      },
      "mint-authority": {
        term: "Mint Authority",
      ...
      "confidential-transfers": {
        term: "Transfer\xEAncias Confidenciais",
        definition: "A Token-2022 extension that uses zero-knowledge proofs (Twisted ElGamal encryption over Ristretto255) to hide transfer amounts while keeping the token mint and accounts public. Balances are stored in encrypted form with separate 'pending' and 'available' pools. The account owner can decrypt their balance but others cannot see amounts."
      },
      "transfer-fee": {
        term: "Transfer Fee Extension",
      ...
      nft: {
        term: "NFT (Token N\xE3o Fung\xEDvel)",
        definition: "A non-fungible token on Solana\u2014an SPL token with 0 decimals, supply of 1, and revoked mint authority. The NFT's metadata (image, attributes) is stored off-chain (Arweave/IPFS) linked via the Metaplex metadata account's URI field. NFTs can be standard, compressed (cNFT), programmable (pNFT), or Core assets, each with different trade-offs."
      },
      "master-edition": {
        term: "Master Edition",
      ...
      dapp: {
        term: "dApp (Aplica\xE7\xE3o Descentralizada)",
        definition: "An application with its backend logic running on a blockchain as smart contracts rather than centralized servers. dApps typically have a traditional web frontend that interacts with on-chain programs via RPC. Users authenticate with wallets instead of username/password. Examples: Uniswap (Ethereum DEX), Jupiter (Solana DEX), Magic Eden (NFT marketplace)."
      },
      "wallet-general": {
        term: "Carteira",
      ...
      "seed-phrase": {
        term: "Frase Semente (Mnem\xF4nico)",
        definition: "A 12 or 24-word human-readable backup of a wallet's master private key, generated using BIP-39 standard. The seed phrase can deterministically regenerate all derived keypairs (BIP-44 derivation paths). Losing the seed phrase means permanently losing access to all associated accounts. Never share, photograph, or store seed phrases digitally in plain text."
      },
      "defi-general": {
        term: "DeFi (Finan\xE7as Descentralizadas)",
        definition: "Financial services built on blockchain smart contracts that operate without traditional intermediaries (banks, brokers). DeFi includes lending, borrowing, trading, insurance, and derivatives. Key properties: permissionless (anyone can participate), composable (protocols can be combined), transparent (open-source, auditable). Solana DeFi TVL has exceeded $5B, led by Jupiter, Raydium, Marinade, and Kamino."
      },
      tvl: {
        term: "TVL (Total Value Locked)",
      ...
      composability: {
        term: "Composabilidade",
        definition: "The ability of blockchain protocols to interact with and build upon each other like building blocks ('money legos'). A lending protocol can accept LP tokens as collateral, which were minted by a DEX, which uses an oracle for pricing\u2014all in a single transaction. Solana's CPI mechanism and shared account model make composability a core design principle."
      },
      permissionless: {
        term: "Sem Permiss\xE3o",
        definition: "A system that anyone can participate in without requiring approval from a central authority. Permissionless blockchains allow anyone to run a node, submit transactions, deploy programs, or build applications. This property enables censorship resistance and open innovation but also means malicious actors can participate, requiring protocol-level security mechanisms."
      },
      trustless: {
        term: "Sem Confian\xE7a",
        definition: "A system where participants don't need to trust each other or a central authority because rules are enforced by code and cryptographic proofs. Smart contracts execute deterministically\u2014the outcome is guaranteed by the protocol, not by any party's goodwill. 'Trust-minimized' is often more accurate, as users still trust the code, validators, and protocol design."
      },
      "rpc-general": {
        term: "RPC (Remote Procedure Call)",
...
// require("../data/i18n/**/*.json") in src/i18n.ts
var globRequire_data_i18n_json = __glob({
  "../data/i18n/es.json": () => require_es(),
  "../data/i18n/pt.json": () => require_pt()
});

// src/i18n.ts
function getLocalizedTerms(locale) {
  let overrides = {};
  try {
    overrides = globRequire_data_i18n_json(`../data/i18n/${locale}.json`);
  } catch {
    return allTerms;
  }
